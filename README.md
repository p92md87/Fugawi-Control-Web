...
## Estado
- **v007**: interfaz guiada por tareas y validador geométrico Q47, optimizada para iPad.
...
- Incluye «Validar geometría / Q47»: selección local de `4-5 SALAMANCA.PNG`, recorte Q47, cuatro subcuadriláteros, sombreado del exterior de Q47, toque de control, exclusiones, diagnóstico de distancia al borde, interpolación bilineal, controles pendientes IGN/PNOA, «Nueva prueba Q47», registro correcto de la selección actual, autotest de serialización y exportación de traza.
