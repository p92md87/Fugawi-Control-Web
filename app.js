(() => {
  ...
  const CONFIG_KEY = "fugawiControlConfigV006";
  const OLD_CONFIG_KEY = "fugawiControlConfigV005";
  ...
  $("exportHistoryBtn").addEventListener("click", () => {
    download(
      "Historial_Fugawi_Control_v006.json",
