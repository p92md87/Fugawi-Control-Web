(() => {
  ...
  const CONFIG_KEY = "fugawiControlConfigV009";
  const OLD_CONFIG_KEY = "fugawiControlConfigV008";
  ...
  $("exportHistoryBtn").addEventListener("click", () => {
    download(
      "Historial_Fugawi_Control_v009.json",
